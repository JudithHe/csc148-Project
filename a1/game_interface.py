...
from subtractsquare import SubtractSquare
...
class GameInterface:
    ...
    def play(self) -> None:
        ...
        while not self.game.is_over(current_state):
            ...
            # make sure that current_strategy has a value, = p2_strategy(output)
            ...
            current_state = self.game.current_state  # like increment
